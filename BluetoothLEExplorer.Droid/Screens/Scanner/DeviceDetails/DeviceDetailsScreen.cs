...
namespace BluetoothLEExplorer.Droid.Screens.Scanner.DeviceDetails
{
	...
	public class DeviceDetailsScreen : ListActivity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			base.Title = App.Current.State.SelectedDevice.Name;// + " " + App.Current.State.SelectedDevice.Address;
//			var rssi = bundle.GetShort (BluetoothDevice.ExtraRssi);
//			if (!string.IsNullOrWhiteSpace (rssi.ToString()))
//				base.Title = Title + " rssi:" + rssi.ToString();
			// create our adapter
